...
Exercice.create(title: "Entraînement explosif", composition: "Box jumps, Sprints, Pompes plyométriques", description: "Développez votre puissance explosive avec cet entraînement. Les box jumps, sprints et pompes plyométriques renforcent vos muscles et améliorent votre agilité.", category: "full body")

Exercice.create(title: "Renforcement du noyau", composition: "Planche, Crunchs, Levée de jambes", description: "Travaillez vos abdominaux et renforcez votre noyau avec cet ensemble d'exercices comprenant des planches, des crunchs et des levées de jambes. Améliorez votre stabilité.", category: "bas du corps")

Exercice.create(title: "Entraînement des épaules", composition: "Élévations latérales, Développé militaire, Shrugs", description: "Sculptez vos épaules avec cet entraînement. Les élévations latérales, le développé militaire et les shrugs vous aident à obtenir des épaules définies.", category: "haut du corps")

Exercice.create(title: "Entraînement des jambes", composition: "Squats, Extensions quadriceps, Fentes", description: "Renforcez vos jambes avec cet ensemble d'exercices comprenant des squats, des extensions quadriceps et des fentes. Améliorez la puissance et la stabilité de vos membres inférieurs.", category: "bas du corps")

Exercice.create(title: "Circuit cardio express", composition: "Jumping jacks, Burpees, Course à pied", description: "Stimulez votre système cardiovasculaire avec ce circuit rapide. Les jumping jacks, burpees et la course à pied augmentent l'endurance tout en brûlant des calories.", category: "full body")

Exercice.create(title: "Entraînement du dos", composition: "Tractions, Rowing, Hyperextensions", description: "Renforcez les muscles de votre dos avec cet ensemble d'exercices, incluant des tractions, du rowing et des hyperextensions. Améliorez la posture et la force dorsale.", category: "haut du corps")
...
Exercice.create(title: "Entraînement des bras", composition: "Curls biceps, Extensions triceps, Pompes", description: "Développez des bras forts avec cet ensemble d'exercices ciblant les biceps et les triceps. Les curls, extensions triceps et pompes vous aident à sculpter des bras toniques.", category: "haut du corps")

Exercice.create(title: "Entraînement pliométrique", composition: "Jump squats, Burpees, Box jumps", description: "Améliorez votre explosivité avec cet entraînement pliométrique. Les jump squats, burpees et box jumps sollicitent les muscles de manière dynamique pour des résultats rapides.", category: "full body")

Exercice.create(title: "Entraînement du haut du corps", composition: "Developpé couché, Pull-ups, Dips", description: "Sculptez votre haut du corps avec cet ensemble d'exercices, incluant le développé couché, les pull-ups et les dips. Renforcez vos muscles du torse, du dos et des épaules.", category: "haut du corps")
...
Exercice.create(title: "Séance de stretching", composition: "Étirements dynamiques, Yoga, Relaxation", description: "Libérez la tension musculaire avec cette séance de stretching. Les étirements dynamiques, le yoga et la relaxation améliorent la souplesse et réduisent le stress.", category: "full body")

Exercice.create(title: "Entraînement des fessiers", composition: "Hip thrusts, Fentes arrière, Glute bridges", description: "Tonifiez et renforcez vos fessiers avec cet ensemble d'exercices. Les hip thrusts, fentes arrière et glute bridges sculptent des fesses fermes et fortes.", category: "bas du corps")
...
Exercice.create(title: "Entraînement du bas du corps explosif", composition: "Sauts en boîte, Jump lunges, Squats sautés", description: "Développez la puissance de vos jambes avec cet entraînement explosif. Les sauts en boîte, jump lunges et squats sautés stimulent la force et l'agilité.", category: "bas du corps")
...
Exercice.create(title: "Entraînement de la ceinture abdominale", composition: "Plank, Russian twists, Leg raises", description: "Sculptez vos abdominaux avec cet ensemble d'exercices. Le plank, les Russian twists et les leg raises renforcent la ceinture abdominale pour une silhouette tonique.", category: "bas du corps")

Exercice.create(title: "Entraînement de sprint", composition: "Sprints courts, Sprints longs, Marche de récupération", description: "Boostez votre vitesse et votre puissance avec cet entraînement de sprint. Les sprints courts, sprints longs et la marche de récupération améliorent votre performance athlétique.", category: "bas du corps")

Exercice.create(title: "Circuit de renforcement du haut du corps", composition: "Pull-ups, Push-ups, Dips", description: "Renforcez efficacement le haut de votre corps avec ce circuit. Les pull-ups, push-ups et dips travaillent les muscles du dos, de la poitrine et des bras.", category: "haut du corps")
...
Exercice.create(title: "Entraînement de boxe", composition: "Shadow boxing, Sac de frappe, Burpees", description: "Améliorez votre condition physique et libérez du stress avec cet entraînement de boxe. Le shadow boxing, le sac de frappe et les burpees sollicitent l'ensemble du corps.", category: "full body")

Exercice.create(title: "Entraînement des ischio-jambiers", composition: "Deadlifts, Leg curls, Glute-ham raises", description: "Renforcez les ischio-jambiers avec cet ensemble d'exercices. Les deadlifts, leg curls et glute-ham raises contribuent à la stabilité et à la puissance des muscles postérieurs.", category: "bas du corps")

Exercice.create(title: "Circuit d'agilité", composition: "Agility ladder drills, Cone drills, Sprints en zigzag", description: "Développez votre agilité et votre coordination avec ce circuit. Les agility ladder drills, cone drills et sprints en zigzag améliorent la réactivité musculaire.", category: "full body")

Exercice.create(title: "Entraînement de natation", composition: "Nage libre, Brasse, Plongeons", description: "Travaillez votre endurance et renforcez vos muscles avec cet entraînement de natation. La nage libre, la brasse et les plongeons sollicitent l'ensemble du corps.", category: "full body")

Exercice.create(title: "Yoga pour la force intérieure", composition: "Postures de guerrier, Chaturanga, Méditation", description: "Renforcez votre force intérieure avec cet entraînement de yoga. Les postures de guerrier, chaturanga et méditation favorisent l'équilibre entre le corps et l'esprit.", category: "full body")
